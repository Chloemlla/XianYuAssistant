...
```bash
# 克隆项目
git clone https://github.com/Chloemlla/XianYuAssistant.git
cd XianYuAssistant
...
**仓库地址**:
- 🌍 GitHub: https://github.com/Chloemlla/XianYuAssistant
...
[![Star History Chart](https://api.star-history.com/svg?repos=Chloemlla/XianYuAssistant&type=Date)](https://star-history.com/#Chloemlla/XianYuAssistant)
