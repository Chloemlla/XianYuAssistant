...
# 使用方法: curl -fsSL https://raw.githubusercontent.com/Chloemlla/XianYuAssistant/master/install.sh | bash
#
...
# GitHub API
GITHUB_API="https://api.github.com/repos/Chloemlla/XianYuAssistant/releases/latest"
